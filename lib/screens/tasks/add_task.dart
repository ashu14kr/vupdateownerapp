...
import 'package:vupdate/screens/tasks/add_team_member.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomtextField(
                  hint: "Enter project name", color: Colors.grey, text: fullname,),
              Divider(
                height: 0.5,
                thickness: 0.5,
                color: maincolor,
              ...
              SizedBox(
                  ...
                  child: CustomtextField(
                      hint: "Enter Project Description", color: Colors.grey, text: fullname,)),
              SizedBox(
                height: size.height / 60,
              ),
              Divider(
